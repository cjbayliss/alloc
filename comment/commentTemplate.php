...
$url_alloc_commentTemplateList = $page->getURL('url_alloc_commentTemplateList');

$commentTemplateID = $_POST['commentTemplateID'] ?? $_GET['commentTemplateID'] ?? '';
...
$main_alloc_title = 'Edit Comment Template - ' . APPLICATION_NAME;
...
echo <<<HTML
    ...
    <table class="box">
      ...
      <tr>
        ...
        <td class="top center">{$page->textarea('commentTemplateText', $commentTemplateText, ['height' => 'jumbo'])}
          <br>
