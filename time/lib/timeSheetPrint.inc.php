...
class timeSheetPrint
{
    ...
    public function get_printable_timeSheet_file($timeSheetID, $timeSheetPrintMode, $printDesc, $format)
    {
        ...
        if ($timeSheetID) {
            ...
            if ('money' == $timeSheetPrintMode) {
                $default_header = 'Tax Invoice';
                $default_id_label = 'Invoice Number';
            }

            if ('estimate' == $timeSheetPrintMode) {
            ...
            if ('html' != $format) {
                ...
                if ('estimate' == $timeSheetPrintMode) { // This line needs to be glued to the above line
                ...
                if ('money' == $timeSheetPrintMode || 'estimate' == $timeSheetPrintMode) {
                ...
                } elseif ('units' == $timeSheetPrintMode) {
                    ...
                    $y = $cezpdf->ezTable($rows, $cols2, '', $pdf_table_options3);
                } elseif ('items' == $timeSheetPrintMode) {
