...
class InterestedParty extends DatabaseEntity
{
    ...
    public static function adjust_by_email_subject($email_receive, $e)
    {
        ...
        foreach ((array) $commands as $command) {
            ...
            if ('quiet' == $command) {
            ...
            } elseif ('unsub' == $command || 'unsubscribe' == $command) {
            ...
            } elseif ('sub' == $command || 'subscribe' == $command) {
                ...
                $duration = $m[1];
                if (is_numeric($duration) && (is_object($object) && 'task' == $object->classname && $object->get_id() && $current_user->get_id())) {
